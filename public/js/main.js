require([], function (){
    ...
    // PC
    //$("#container .left-col .overlay").css({"background-color": colorList[id],"opacity": .3});//delete by victor at 2017.02.21
    // Mobile
    //$("#container #mobile-nav .overlay").css({"background-color": colorList[id],"opacity": .7});//delete by victor at 2017.02.21
